...
//กราฟน้ำหนัก
                  ...
                  $userMessage = 'https://remi.softbot.ai/uploads/'.$img ;
//เพิ่ม
...
//////////////////////////////////////////////////////////////////
                  ...
                  case ($userMessage == 'คำนวณค่าดัชนีมวลกายอย่างไร?'): 
                        $case = 18;
                        $userMessage  = 'https://remi.softbot.ai/knowledge/bmi-cal.jpg';
                    break;
                  case ($userMessage == 'คุณแม่รูปร่างต่างกันน้ำหนักควรเพิ่มเท่าไร?'): 
                        $case = 18;
                        $userMessage  = 'https://remi.softbot.ai/knowledge/incre-weight.jpg';
                    break;
