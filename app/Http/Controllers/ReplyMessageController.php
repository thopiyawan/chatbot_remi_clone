                 ...
                 $textMessageBuilder = new TemplateMessageBuilder('คุณแม่เคยลงทะเบียนกับ ulife.info ไหม?', new ConfirmTemplateBuilder('คุณเคยลงทะเบียนกับ ulife.info ไหม?' ,
                  ...
                  $textMessage1 = new TextMessageBuilder($text1);
                    ...
                    // $imageMapUrl = 'https://remi.softbot.ai/food/new_nutri2.jpg?_ignored=';
                     $imageMapUrl = 'https://remi.softbot.ai/image/mapmess.jpg?_ignored=';
                    $textMessage2 = new ImagemapMessageBuilder(
                        ...
                        array(
                            new ImagemapMessageActionBuilder(
                                ...
                                new AreaBuilder(0,0,346,260)
                                ),
                            new ImagemapMessageActionBuilder(
                                'คุณแม่รูปร่างต่างกันน้ำหนักควรเพิ่มเท่าไร?',
                                new AreaBuilder(346,0,346,260)
                                ),
                            new ImagemapMessageActionBuilder(
                                'อาหารที่คุณแม่ควรทาน',
                                new AreaBuilder(692,0,346,260)
                                ),


                            new ImagemapMessageActionBuilder(
                                'ไม่กิน [อาหารบางชนิด] กินอะไรแทนดี?',
                                new AreaBuilder(0,260,346,333)
                                ),
                            new ImagemapMessageActionBuilder(
                                'สัดส่วนอาหาร',
                                new AreaBuilder(346,260,346,333)
                                ),
                            new ImagemapMessageActionBuilder(
                                'ซื้ออาหารกินข้างนอก จะกะปริมาณอย่างไร?',
                                new AreaBuilder(692,260,346,333)
                                ),


                            new ImagemapMessageActionBuilder(
                                'กินไม่ถึง หรือกินเกิน ทำอย่างไร?',
                                new AreaBuilder(0,520,346,333)
                                ),
                            new ImagemapMessageActionBuilder(
                                'ท้องผูก ท้องอืด ทำอย่างไร?',
                                new AreaBuilder(346,520,346,333)
                                ),
                            new ImagemapMessageActionBuilder(
                                'แพ้ท้อง กินอย่างไร?',
                                new AreaBuilder(692,520,346,333)
                                ),


                            new ImagemapMessageActionBuilder(
                                'ไม่อิ่ม ทำอย่างไร?',
                                new AreaBuilder(0,780,346,333)
                                ),
                            new ImagemapMessageActionBuilder(
                                'อาหารอะไรที่ควรหลีกเลี่ยง?',
                                new AreaBuilder(346,780,346,333)
                                ),
                             new ImagemapMessageActionBuilder(
                                'อื่น ๆ (ฝากคำถามไว้ได้)',
                                new AreaBuilder(692,780,346,333)
                                ),
              ...
              case 39:
                ...
                foreach ($pregnants_lists as $pregnants_list) {
                    ...
                    $columnTemplateBuilder = new CarouselColumnTemplateBuilder(
                                  ...
                                  'รายละเอียดลูกน้อย',
                                  'https://remi.softbot.ai/week/'.$pregnants_list['week'].'.jpg',
                          [
  ...
  public function replymessage_menu3($replyToken,$user)
      {
        ...
        new ImageCarouselTemplateBuilder(
            array(
                new ImageCarouselColumnTemplateBuilder(
                    'https://remi.softbot.ai/knowledge/1-467-pic20160128170301.jpg',
                    new UriTemplateActionBuilder(
                ...
                new ImageCarouselColumnTemplateBuilder(
                    'https://remi.softbot.ai/knowledge/2-467-pic20160128170348.jpg',
                    new UriTemplateActionBuilder(
                        'Uri', // ข้อความแสดงในปุ่ม
                        'https://remi.softbot.ai/knowledge/2-467-pic20160128170348.jpg'
                    )
                ...
                new ImageCarouselColumnTemplateBuilder(
                    'https://remi.softbot.ai/knowledge/3-467-pic20160128170601.jpg',
                    new UriTemplateActionBuilder(
                        'Uri', // ข้อความแสดงในปุ่ม
                        'https://remi.softbot.ai/knowledge/3-467-pic20160128170601.jpg'
                    )
                ...
                new ImageCarouselColumnTemplateBuilder(
                    'https://remi.softbot.ai/knowledge/4-467-pic20160128170609.jpg',
                    new UriTemplateActionBuilder(
                        'Uri', // ข้อความแสดงในปุ่ม
                        'https://remi.softbot.ai/knowledge/4-467-pic20160128170609.jpg'
                    )
                ...
                new ImageCarouselColumnTemplateBuilder(
                    'https://remi.softbot.ai/knowledge/5-467-pic20160128170618.jpg',
                    new UriTemplateActionBuilder(
                        'Uri', // ข้อความแสดงในปุ่ม
                        'https://remi.softbot.ai/knowledge/5-467-pic20160128170618.jpg'
                    )
    ...
    public function replymessage_menu11($replyToken,$user)
      {
        ...
        new ImageCarouselTemplateBuilder(
            array(
                new ImageCarouselColumnTemplateBuilder(
                    'https://remi.softbot.ai/knowledge/6-467-pic20160128170626.jpg',
                    new UriTemplateActionBuilder(
                        'Uri', // ข้อความแสดงในปุ่ม
                        'https://remi.softbot.ai/knowledge/6-467-pic20160128170626.jpg'
                    )
                ...
                new ImageCarouselColumnTemplateBuilder(
                    'https://remi.softbot.ai/knowledge/7-467-pic20160128170631.jpg',
                    new UriTemplateActionBuilder(
                        'Uri', // ข้อความแสดงในปุ่ม
                        'https://remi.softbot.ai/knowledge/7-467-pic20160128170631.jpg'
                    )
